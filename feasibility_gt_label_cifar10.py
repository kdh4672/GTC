...
if is_test_dataset:
    ...
    dataloader = torch.utils.data.DataLoader(train_c_set, batch_size=batch_size,
                                                        shuffle=False)
    fixed_dataloader = torch.utils.data.DataLoader(test_c_set, batch_size=batch_size,
                                                        shuffle=False)
...
dataloader = torch.utils.data.DataLoader(
    train_c_set, batch_size=batch_size, shuffle=True)
